...
| 按公司查开源项目与公开资源 | [具身智能公司的开源项目](具身智能公司的开源项目.md) | 按国家／地区浏览公司项目，查看具体用途，展开“已公开内容”了解公开资源，并通过来源链接进入仓库或项目主页 |
...
| 查询公司与产品平台 | [公司与产品主表](公司与产品主表.md) | 按国家或地区查询公司及其机器人本体、核心部件、模型、数据与开发平台 |
...
代表项目包括[GMR](https://github.com/YanjieZe/GMR)、[GVHMR](https://github.com/zju3dv/GVHMR)、[OmniRetarget](https://github.com/amazon-far/holosoma)和[HumanoidMimicGen](https://humanoidmimicgen.github.io/)。完整页面收录**18篇论文/技术报告和47个项目**。
...
代表项目包括[Humanoid-Gym](https://github.com/roboterax/humanoid-gym)、[BFM-Zero](https://github.com/LeCAR-Lab/BFM-Zero)、[Project Instinct](https://project-instinct.github.io/)和[Legged Lab DWAQ](https://gitee.com/chaomingsanhua/legged_lab)。完整页面收录**39篇论文/技术报告和62个项目**。
...
代表项目包括[BeyondMimic](https://github.com/HybridRobotics/whole_body_tracking)、[HoloMotion](https://github.com/HorizonRobotics/HoloMotion)、[OmniH2O](https://omni.human2humanoid.com/)、[MimicKit](https://github.com/xbpeng/MimicKit)和[engineai_rl_lab](https://github.com/engineai-robotics/engineai_rl_lab)。完整页面收录**41篇论文/技术报告和53个项目**。
...
代表项目包括[DoorMan](https://doorman-humanoid.github.io/)、[OmniContact](https://github.com/Ingrid789/OmniContact_sim2sim)、[CoorDex](https://github.com/Skevinci/coordex)和[Thor](https://baai-aether.github.io/baai-thor/)。完整页面收录**36篇论文/技术报告和38个项目**。
...
完整页面收录**17篇论文/技术报告和288个项目**。项目数量较多，是因为本体接口、仿真器、控制库、数据工具和部署工程都在这一层汇合。
...
| [具身智能数据集](数据集/README.md) | 按数据来源、本体依赖、动作表示和训练用途查找40项数据集与相关数据资源 |
| [论文与技术报告总索引](论文与项目/README.md) | 212篇论文与技术报告按最终系统作用分类，可按稳定`Pxxx`编号进入独立解读 |
| [开源项目主表](论文与项目/开源项目主表.md) | 597个项目的研发位置、关键实现、开源边界与开发价值 |
| [具身智能公司的开源项目](具身智能公司的开源项目.md) | 按国家／地区汇总83家公司／机构、412个项目条目，列出具体用途，并可展开查看已公开内容 |
| [公司与产品主表](公司与产品主表.md) | 按国家或地区整理的183家公司/机构及其公开产品与平台 |
...
- 公司自述、论文结果和第三方证据不能相互替代；公司目录不构成强弱排名或投资建议。
